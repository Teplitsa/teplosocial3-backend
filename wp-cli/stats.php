...
//        $date_last_day_to_display = \Teplosocial\utils\get_yesterday_mysql_date();
        ...
        $stats['registered_users_count'] = UserStats::get_registered_count($date_week_ago, $date_last_day);
        ...
        $stats['completed_modules_count'] = ModuleStats::get_completed_count($date_week_ago, $date_last_day);
    ...
    private function compose_stats_html($stats, $stats_titles, $stats_goals) {
        ...
        foreach($stats_titles as $key => $title) {
            ...
            echo '<td>('.$stats['total_'.$key].' / '.$stats_goals[$key].')&nbsp;</td>';
            echo '</tr>';
